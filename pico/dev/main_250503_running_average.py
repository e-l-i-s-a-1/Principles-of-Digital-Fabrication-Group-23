...
sample_delay = 0.15 # delay between cycles [s]
...
th_value = th_value + th_value * 0.4
...
print("-> speed range: %d - %d" % (int(speed_transfer + speed_factor * min_max_values[0]), int(speed_transfer + speed_factor * min_max_values[1])))
...
servo_inc = 3 # rotation increment [deg]
servo_delay = 0.005 # delay between rotation increments [s]

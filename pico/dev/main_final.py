...
sample_delay = 0.1 # delay between cycles [s] # TUNING PARAMETER
...
speed_transfer = 55000 # TUNING PARAMETER
...
try:
    while True:
        ...
        # modify threshold if current conditions (running average) have changed enough
        if abs(light_value - threshold) > 2000:
